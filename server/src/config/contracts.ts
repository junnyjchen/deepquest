...
export const AVE_PAIR_ADDRESS = '0x0000000000000000000000000000000000000000'; // PancakeSwap Pair 地址（需配置）
export const DQTOKEN_CONTRACT_ADDRESS = '0x0000000000000000000000000000000000000000'; // DQToken 地址（需配置）
export const DQCARD_CONTRACT_ADDRESS = '0x0000000000000000000000000000000000000000'; // DQCard 地址（需配置）
