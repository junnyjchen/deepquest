...
contract DQCard is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_A = 1000;  // 改为可变量
    uint256 public MAX_B = 500;   // 改为可变量
    uint256 public MAX_C = 100;   // 改为可变量
