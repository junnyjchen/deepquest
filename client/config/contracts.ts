...
export const DQPROJECT_ABI = [
  ...
  // 将手续费（SOL）分配到 LP 分红池（将 SOL 转给 stake 合约并触发分发）
 ...
 * - 下面“合约地址”仅为历史/备注，可能已过期。
 *
 * 备注合约地址: 0x8F0fb2E3Dd7564C8fCa82050934A576Ecdf74006
 */
