...
contract DQProject is Ownable, ReentrancyGuard {
    ...
    struct User {
        ...
        uint256 totalInvest;
        uint256 teamInvest;
        uint256 energy;        // 能量�?(入金额�?)
        uint256 directSales;
        bool hasNode;          // 是否持有节点NFT
        bool hasDeposited;     // 是否已完成首次入�?
    ...
    uint256 public burnRate = 80;          // 80%销�?
     ...
     * @notice 单币质押DQ
     * @param amount 质押数量
     * @param periodIndex 质押周期索引 (0=30�? 1=90�? 2=180�? 3=360�?
     */
