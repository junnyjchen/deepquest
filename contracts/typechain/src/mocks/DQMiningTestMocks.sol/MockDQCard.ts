...
export interface MockDQCardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "PRICE_A"
      | "PRICE_B"
...
export interface MockDQCard extends BaseContract {
  connect(runner?: ContractRunner | null): MockDQCard;
  waitForDeployment(): Promise<this>;

  interface: MockDQCardInterface;
